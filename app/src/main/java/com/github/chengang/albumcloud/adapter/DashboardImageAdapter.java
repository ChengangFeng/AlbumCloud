...
public class DashboardImageAdapter extends BaseRecyclerViewAdapter<String> {

    private Context mContext;

    public DashboardImageAdapter(@NonNull Context context, @NonNull List<String> datas) {
        super(context, datas);
    ...
    protected int getLayoutResId(int viewType) {
        return R.layout.item_dashboard_image;
    }

    @Override
    protected BaseRecyclerViewHolder getViewHolder(ViewGroup parent, View rootView, int viewType) {
        return new DashboardImageVH(rootView, viewType);
    }

    class DashboardImageVH extends BaseRecyclerViewHolder<String> {

        @BindView(R.id.image)
        ImageView mImageView;

        DashboardImageVH(View itemView, int viewType) {
            super(itemView, viewType);
            ButterKnife.bind(this, itemView);
        }

        @Override
        public void onBindData(String imageUrl, int position) {
